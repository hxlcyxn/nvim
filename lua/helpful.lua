...
function M.setoption(opts)
  for option, value in pairs(opts) do vim.o[option] = value end
end
...
function M.buf_setoption(opts)
  for option, value in pairs(opts) do vim.bo[option] = value end
end
...
function M.setglobal(globs)
  for global, value in pairs(globs) do vim.g[global] = value end
end
